...
const App: React.FC = () => {
  ...
  <Flex vertical style={{padding: 20}}>
    ...
    >
      <b>Terms and Conditions for RealBook</b>
    </Typography>
    <Divider orientation="right" style={{color:"black"}}>
      Last updated: February 28, 2024
    </Divider>
    <Typography style={{ fontSize: 24 }}>Terms and Conditions : </Typography>
    <Typography>
    ...
    <Typography style={{marginLeft: 20}}>
      ...
      <li>
        ...
        this Agreement) refers to Realbook.
      </li>
      <li>
      ...
      <li>Website refers to Realbook, accessible from www.realbook</li>
      <li>
    ...
    <Typography style={{ fontSize: 24 }}>Acknowledgment :</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Termination :</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Limitation of Liability :</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Governing Law :</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Disputes Resolution :</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Severability and Waiver :</Typography>
    <Typography style={{ fontSize: 20 }}>Severability</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 20 }}>Waiver</Typography>
    <Typography>
    ...
    <Typography style={{ fontSize: 24 }}>Translation Interpretation :</Typography>
    <Typography>
