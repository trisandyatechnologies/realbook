...
const data = [
  {
    ...
    status: (
      <>
        <Button className="tag-primary">ONLINE</Button>
      </>
    ),
    employed: (
      <>
      ...
      <>
        <Avatar.Group>
          <Avatar
            ...
            size={40}
            src={
              "C:Users\venkaOneDriveDesktopproject\realbookpublicimages\face-5.jpeg"
            }
          ></Avatar>
          <div className="avatar-info">
      ...
      <>
        <Avatar.Group>
          <Avatar
            ...
            size={40}
            src={
              "C:Users\venkaOneDriveDesktopproject\realbookpublicimages\face-6.jpeg"
            }
          ></Avatar>
          <div className="avatar-info">
          ...
          <Col xs="24" xl={24}>
            ...
            >
              ...
              <div className="uploadfile pb-15 shadow-none">
                <Upload {...formProps}>
                  <Button className="ant-full-box" icon={<ToTopOutlined />}>
                    Click to Upload
                  </Button>
                </Upload>
              </div>
