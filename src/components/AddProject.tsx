              ...
              <Flex vertical>
                ...
                <Form.Item label="Category" name="category">
                  <Select>
                    ...
                    <Select.Option value="Individual_Houses">
                      Individual_Houses
                    </Select.Option>
                    <Select.Option value="Apartments">Apartments</Select.Option>
                    <Select.Option value="Plots">Plots</Select.Option>
                    <Select.Option value="Grouped_House">
                      Grouped_House
                    </Select.Option>
                    <Select.Option value="Gated_Community">
                      Gated_Community
                    </Select.Option>
                    <Select.Option value="Semi_Gated_Community">
                      Semi_Gated_Community
                    </Select.Option>
                    <Select.Option value="Standalone_Building">
                      Standalone_Building
                    </Select.Option>
                  </Select>
                </Form.Item>
              ...
              <Flex vertical>
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please input your village Name!",
                    },
                  ]}
                >
                  <Input
                ...
                >
                  <Input placeholder="City name " style={{ borderRadius: 5 }} />
                </Form.Item>
                <Form.Item
                  label="State"
                  name={["address", "state"]}
                ...
                >
                  <Input placeholder="State name" style={{ borderRadius: 5 }} />
                </Form.Item>
                <Form.Item
                  label="Country"
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: false,
                      message: "Please input your survey no!",
                    },
                  ]}
                >
                  <Input placeholder="Survey no " style={{ borderRadius: 5 }} />
                </Form.Item>
                <Form.Item
                  label="Land mark"
