...
function Header({
  ...
  placement?: any;
  onPress: () => void;
  handleSidenavColor: (s: string) => void;
  handleSidenavType: (s: string) => void;
  handleFixedNavbar: (e: SyntheticEvent<ChangeEvent>) => void;
}) {
  ...
  return (
    <div>
      ...
      <Row gutter={[24, 0]} style={{ display: "flex", justifyContent: "end" }}>
        <Col
          span={24}
          md={6}
        ...
        <Col span={24} md={18} className="header-control">
          ...
          <Button colour="link" onClick={showDrawer}>
            {logsetting}
          </Button>
          <Button
            colour="link"
          ...
          >
            <Row>
              ...
              <Col className="sidebar-color">
                ...
                <Col className="theme-color mb-2">
                  <ButtonGroup>
                    <Button
                      colour="primary"
                ...
                <Col className="sidebarnav-color mb-2">
                ...
                <Col className="fixed-nav mb-2">
                  <Title level={5}>Navbar Fixed </Title>
                </Col>
                <Col className="ant-docment">
                  <ButtonGroup>
                ...
                <Col className="viewstar">
                  <a href="#pablo">{<StarOutlined />} Star</a>
                  <a href="#pablo"> 190</a>
                </Col>

                <Col className="ant-thank">
                  <Title level={5} className="mb-2">
                    Thank you for sharing!
                  </Title>
                  <ButtonGroup className="social">
